    ...
    protected void deliverAndDrawFrame(CvCameraViewFrame frame) {
        ...
        if (bmpValid && mCacheBitmap != null) {
            ...
            if (canvas != null) {
                ...
                //Log.i("OpenCV4AndroidDemo", rotation + "" + Surface.ROTATION_0);
                //switch (rotation) {
                ...
                // 采用前摄像头的情况
                float mScale = canvas.getWidth() / (float) mCacheBitmap.getHeight();
                ...
                Log.i(TAG, canvas.getHeight() + "," + canvas.getWidth() + "," + mCacheBitmap.getHeight() + "," + mCacheBitmap.getWidth());
                // 旋转
                canvas.rotate(90);
                //// 平移
                canvas.translate(0, -mCacheBitmap.getHeight());
                //// 左右镜像
